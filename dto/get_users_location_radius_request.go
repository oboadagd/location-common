...
type GetUsersByLocationAndRadiusRequest struct {
	...
	Longitude  float64 `json:"longitude" validate:"required,min=-180,max=180,maxDecimals"` // longitude coordinate of username's location. It is required, belongs to range -90 to 90, allows 8 decimal positions
